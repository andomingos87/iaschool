...
- [R9 Supabase QA quirks](r9-supabase-qa.md) — app now runs on live Supabase; example.com emails rejected, signup rate limits, 404 = schema not applied, `#type=recovery` opens reset screen.
