...
Read `artifacts/iasport/docs/AGENTS.md` first. React Native does
...
`artifacts/iasport/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/iasport/tokens";
...
```tsx
import { nativeTheme } from "@workspace/iasport/lib/native-theme";
import { useColors } from "@workspace/iasport/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/iasport/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/iasport/components/native/badge";
import { Button } from "@workspace/iasport/components/native/button";
import { Card } from "@workspace/iasport/components/native/card";
```
...
Import and render
`@workspace/iasport/components/native/button`, then run Expo
