...
workspace package (`@workspace/iaschool-ui`): other artifacts depend
...
`@workspace/iaschool-ui/components/...`. Never use a `@/` alias inside
...
for `@workspace/iaschool-ui` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/iaschool-ui` as a `workspace:*` dependency,
run `pnpm install`, and import directly from this package.

Read only the guides required by the current task:

- Building or styling web UI: `artifacts/iaschool-ui/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/iaschool-ui/docs/consuming-expo.md`
