...
import {
  ...
  SheetTitle,
  SheetDescription,
} from "@workspace/iasport/components/ui/sheet";
import {
  Collapsible,
  CollapsibleContent,
  CollapsibleTrigger,
} from "@workspace/iasport/components/ui/collapsible";
...
// Tela de auditoria das gerações de imagem — exclusiva do admin da IAsport.
