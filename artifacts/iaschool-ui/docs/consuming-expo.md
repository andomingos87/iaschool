...
`artifacts/iaschool-ui/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/iaschool-ui/tokens";
...
```tsx
import { nativeTheme } from "@workspace/iaschool-ui/lib/native-theme";
import { useColors } from "@workspace/iaschool-ui/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/iaschool-ui/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/iaschool-ui/components/native/badge";
import { Button } from "@workspace/iaschool-ui/components/native/button";
import { Card } from "@workspace/iaschool-ui/components/native/card";
```
...
Import and render
`@workspace/iaschool-ui/components/native/button`, then run Expo
